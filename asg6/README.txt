...
A custom data set (as a CSV file) has been created for you. You need to write and test three 
python scripts to process this sales data information (500,000 records) to answer three questions.
